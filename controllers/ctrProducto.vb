    ...
    Public Function ObtenerProductos()
        ...
        Try
            Dim query As String = "select 
                                        tp.id_producto, tp.codigo_prod, tp.nombre_prod, tp.descripcion_prod, tc.nombre_ctg, tp.precio_prod, tp.id_ctg 
                                   from 
                                        td_productos tp 
    ...
    Public Function AgregarProducto(producto As Producto) As Integer
        Try
            Dim query As String = "INSERT INTO td_productos 
                                        (codigo_prod, nombre_prod, descripcion_prod, id_ctg, precio_prod) 
                                   VALUES
                                        (@codigo_prod, @nombre_prod, @descripcion_prod, @id_ctg, @precio_prod);
